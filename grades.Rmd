...
#mytable <- table(dat$ID, dat$Instructor, dat$Term)
#ftable(mytable)
...
# temp <- d3_dum %>%
#   select(Term_20203,Term_20193, UPPER, 
...
#   ID_WILD314, 
#  Instructor_12, Instructor_11) %>%
#   mutate_all(as.numeric())%>%
#   summarise(mean = colMeans(.))


#finish_dat <- d3_dum %>%
#   select(PCT_FINISH, Term_20203, Term_20193, UPPER, 
#   ID_AGBU310, ID_AGBU402, 
#   ID_AGSC211, ID_AGSC320, ID_AGSC411, 
#   ID_ANSC230, ID_ANSC223, ID_ANSC224, ID_ANSC301, ID_ANSC315, ID_ANSC340, ID_ANSC409, ID_ANSC411, 
#   ID_FOR111, ID_FOR200, ID_FOR230, ID_FOR233, ID_FOR302, ID_FOR313, ID_FOR402, ID_FOR404, ID_FOR480, 
...
# 
# pass_dat <- d3_dum %>%
#   select(PCT_PASS, Term_20203, Term_20193, UPPER, 
#   ID_AGBU310, ID_AGBU402, 
#   ID_AGSC211, ID_AGSC320, ID_AGSC411, 
#   ID_ANSC230, ID_ANSC223, ID_ANSC224, ID_ANSC301, ID_ANSC315, ID_ANSC340, ID_ANSC409, ID_ANSC411, 
#   ID_FOR111, ID_FOR200, ID_FOR230, ID_FOR233, ID_FOR302, ID_FOR313, ID_FOR402, ID_FOR404, ID_FOR480, 
...
# 
# a_dat <- d3_dum %>%
#   select(PCT_A, Term_20203, Term_20193, UPPER, 
#   ID_AGBU310, ID_AGBU402, 
#   ID_AGSC211, ID_AGSC320, ID_AGSC411, 
#   ID_ANSC230, ID_ANSC223, ID_ANSC224, ID_ANSC301, ID_ANSC315, ID_ANSC340, ID_ANSC409, ID_ANSC411, 
#   ID_FOR111, ID_FOR200, ID_FOR230, ID_FOR233, ID_FOR302, ID_FOR313, ID_FOR402, ID_FOR404, ID_FOR480, 
...
finish_poisson <- glm(finish_formula, family = poisson(link = "identity"), 
                      data = d3_dum)
summary(finish_poisson)
fp <- coeftest(finish_poisson, vcov = vcovHC(finish_poisson, type="HC1"))
fp

pass_poisson <- glm(pass_formula, family = poisson(link = "identity"), 
                    data = d3_dum )
...
# finish_f_t <-  PCT_FINISH/100  ~ Term_20203 + Term_20193 + UPPER + 
#   ID_AGBU310 + ID_AGBU402 + 
#   ID_AGSC211 + ID_AGSC320 + ID_AGSC411 + 
#   ID_ANSC230 + ID_ANSC223 + ID_ANSC224 + ID_ANSC301 + ID_ANSC315 + ID_ANSC340 + ID_ANSC409 + ID_ANSC411 + 
#   ID_FOR111 + ID_FOR200 + ID_FOR230 + ID_FOR233 + ID_FOR302 + ID_FOR313 + ID_FOR402 + ID_FOR404 + ID_FOR480 + 
...
#   Instructor_12 
# 
# pass_f_t <-  PCT_PASS/100  ~ Term_20203 + Term_20193 + UPPER +
#   ID_AGBU310 + ID_AGBU402 + 
#   ID_AGSC211 + ID_AGSC320 + ID_AGSC411 + 
#   ID_ANSC230 + ID_ANSC223 + ID_ANSC224 + ID_ANSC301 + ID_ANSC315 + ID_ANSC340 + ID_ANSC409 + ID_ANSC411 + 
#   ID_FOR111 + ID_FOR200 + ID_FOR230 + ID_FOR233 + ID_FOR302 + ID_FOR313 + ID_FOR402 + ID_FOR404 + ID_FOR480 + 
...
#   Instructor_12 
# 
# A_f_t <-  PCT_A/100  ~ Term_20203 + Term_20193 + UPPER +
#   ID_AGBU310 + ID_AGBU402 + 
#   ID_AGSC211 + ID_AGSC320 + ID_AGSC411 + 
#   ID_ANSC230 + ID_ANSC223 + ID_ANSC224 + ID_ANSC301 + ID_ANSC315 + ID_ANSC340 + ID_ANSC409 + ID_ANSC411 + 
#   ID_FOR111 + ID_FOR200 + ID_FOR230 + ID_FOR233 + ID_FOR302 + ID_FOR313 + ID_FOR402 + ID_FOR404 + ID_FOR480 + 
...
# 
# 
# finish_Tobit <- censReg( finish_f_t, left = 0, right = 1, data = d3_dum,
#    start = NULL, nGHQ = 8 )
# fT <- coeftest(finish_Tobit, vcov.=vcovCL(finish_Tobit, cluster=rownames(d3_dum), type="HC0"))
# 
# 
# pass_Tobit <- censReg( pass_f_t, left = 0, right = 1, data = d3_dum,
#    start = NULL, nGHQ = 8 )
# pT <- coeftest(pass_Tobit, vcov.=vcovCL(pass_Tobit, cluster=rownames(d3_dum), type="HC0"))
# 
# 
# a_Tobit <- censReg( A_f_t, left = 0, right = 1, data = d3_dum,
#    start = NULL, nGHQ = 8 )
# aT <- coeftest(a_Tobit, vcov.=vcovCL(a_Tobit, cluster=rownames(d3_dum), type="HC0"))
...
#, 'ID_AGBU310', 'ID_AGBU402', 'ID_AGSC211', 'ID_AGSC320', 'ID_AGSC411', 'ID_ANSC230', 'ID_ANSC223', 'ID_ANSC224', 'ID_ANSC301', 'ID_ANSC315', 'ID_ANSC340', 'ID_ANSC409', 'ID_ANSC411', 'ID_FOR111', 'ID_FOR200', 'ID_FOR230', 'ID_FOR233', 'ID_FOR302', 'ID_FOR313', 'ID_FOR402', 'ID_FOR404', 'ID_FOR480', 'ID_GISC250', 'ID_GISC260', 'ID_PLSC101', 'ID_PLSC211', 'ID_PLSC310', 'ID_PLSC311', 'ID_PLSC312', 'ID_PLSC400',   'Instructor_12'))

ggFinish <- ggpredict(finish_poisson,  "Term_20203")
predict_Finish <- plot(ggFinish, add.data = TRUE) + 
    xlab('Spring 2020 Binary') +
    ylab('Predicted Percent Finishing') +
    ggtitle('')+ 
...
predict_Pass <- plot(ggPass, add.data = TRUE) + 
    xlab('Spring 2020 Binary') +
    ylab('Predicted Percent Passing') +
    ggtitle('')+ 
  cowplot::theme_minimal_hgrid(11)
...
predict_A <- plot(ggA,add.data = TRUE) + 
  xlab('Spring 2020 Binary') +
    ylab('Predicted Percent Earning A') +
    ggtitle('')+ 
  cowplot::theme_minimal_hgrid(11)
